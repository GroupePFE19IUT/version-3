 ...
 <thead>
   <tr>
     ...
     <th scope="col">Actions</th>
       ...
       <tbody>
         <?php
         foreach ($Listedepartement as $datas) {
           $i=1;
           ?>
         <tr>
           <td><?php echo $i; ?></td>
           <td><?php echo $datas['Code_Derpartement']; ?></td>
           <td><?php echo $datas['Intituler']; ?></td>
           <td>
             <font color="green">
               <a href="#"><span class="glyphicon glyphicon-refresh text-black"></span>|</a>
             </font>
              <a href="<?php //echo site_url("UsersController\delete?id1='.$datas['idDepartement'].';"); ?>">
                <span class="glyphicon glyphicon-trash text-danger"></span>|</a>
              <font color="green">
                <a href="<?php //echo site_url("UsersController\Modifier?id1=$datas['idDepartement']"); ?>">
