     ...
     <th scope="col">Actions</th>
       ...
       <tbody>
         ...
         <tr>
           ...
           <td><?php echo $datas['IntitulerOption']; ?></td>
           <td><?php echo $datas['Code_Parcour']; ?></td>

           <td>
             <font color="green">
               <a href="#"><span class="glyphicon glyphicon-refresh text-black"></span>|</a>
             </font>
              <a href="<?php //echo site_url("UsersController\delete?id1='.$datas['idOption'].';"); ?>">
                <span class="glyphicon glyphicon-trash text-danger"></span>|</a>
              <font color="green">
                <a href="<?php //echo site_url("UsersController\Modifier?id1=$datas['idOption']"); ?>">
